 <template>
  <div>
    ...
    <div class=" mt-5" v-if="category==true">
      <div class="col-12 col-md-12 col-xs-12 " style="right:12px" v-for="st in stats" :key="st.id" v-if="9 == st.category &&st.item==1 ">
    <div class="row mr-0" >
  ...
  <b-form-radio   :value="range.id"  v-model="selected.price" class="ml-2" >{{range.minprice}}-{{range.maxprice}}</b-form-radio>
       ...
       <!-- ./FilterPrice-->
       <!-- FilterUnit-->
       <div class="col-6 col-md-3 col-xs-6 " v-for="st in stats" :key="st.id"  v-if="9 == st.category&&st.item==3"> 
          <div class="col-12 col-md-12 col-xs-12 "  > 
