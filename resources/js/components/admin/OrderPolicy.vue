    ...
    <div class="item col-xs-12 col-md-12 panel-body panel panel-default">
      <div class="table-responsive">
        ...
        >
          ...
          <tbody>
            <tr v-for="(policy, index) in policys" :key="policy.id">
              <td>{{ index + 1 }}</td>
              <td>
                <img
                  :src="'/images/' + policy.image"
                  class="img-responsive"
                  height="35"
                  width="70"
                />
              ...
              <td>
                <div v-html="policy.details"></div>
              </td>
              <td>
                <router-link
                  :to="{ name: 'editpolicy', params: { id: policy.id } }"
                  class="btn btn-primary"
                  ><i class="fa fa-edit"></i>Edit</router-link
                >
                <button
                  class="btn btn-danger"
                  @click.prevent="deletePost(policy.id)"
                >
