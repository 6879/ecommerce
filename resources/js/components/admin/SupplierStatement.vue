<template>
  <div class="row" data-toggle="isotope">
    ...
    >
     ...
     <div class="row" >
         <div
      class="col-xs-12 col-md-6 statement" style=" padding: 10px;padding-left: 23px;" >
    <p>Supplier ID:&nbsp;{{gets.code}}</p>
    <p>Supplier Name:&nbsp;{{gets.name}} </p>
    </div>
         <div
      class="col-xs-12 col-md-6 statement"  style=" padding: 10px;padding-left: 23px;">
   <p>Address: &nbsp;{{gets.address}}</p>
    <p>Phone:&nbsp;{{gets.phone}} </p>
   </div>
     </div>
